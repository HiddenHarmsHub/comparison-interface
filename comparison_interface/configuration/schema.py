...
class WebsiteTextConfiguration(Schema):
    ...
    additionalCheckboxInstructions = fields.Str(required=False, validate=[validate.Length(min=1, max=1000)])
    additionalRadioButtonInstructions = fields.Str(required=False, validate=[validate.Length(min=1, max=1000)])
